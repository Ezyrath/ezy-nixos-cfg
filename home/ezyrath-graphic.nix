_: {
  # setup plasma desktop customizations
  programs.plasma = {
    enable = true;

    shortcuts = {
      ActivityManager.switch-to-activity-d7d84a67-4d06-4852-a496-34a4ff245f1e = [];
      "KDE Keyboard Layout Switcher"."Switch keyboard layout to English (intl., with AltGr dead keys)" = [];
      "KDE Keyboard Layout Switcher"."Switch to Last-Used Keyboard Layout" = "Meta+Alt+L";
      "KDE Keyboard Layout Switcher"."Switch to Next Keyboard Layout" = "Meta+Alt+K";
      "com.google.Chrome"."3D1B4F57C3A65BC3CE988EFC2292FEB4-enter-picker-mode" = [];
      "com.google.Chrome"."3D1B4F57C3A65BC3CE988EFC2292FEB4-enter-zapper-mode" = [];
      "com.google.Chrome"."90632884EF8689DA479116466F90C3D2-addSite" = [];
      "com.google.Chrome"."90632884EF8689DA479116466F90C3D2-switchEngine" = [];
      "com.google.Chrome"."90632884EF8689DA479116466F90C3D2-toggle" = [];
    ...
    configFile = {
      ...
      systemsettingsrc."KFileDialog Settings"."Places Icons Static Size" = 16;
      kcminputrc."Libinput/1133/16519/Logitech G903 LS".PointerAccelerationProfile = 1;
      kcminputrc."Libinput/1133/49297/Logitech G903 LIGHTSPEED Wireless Gaming Mouse w\\/ HERO".PointerAccelerationProfile = 1;
    };
  };
    ...
    userKeymaps = [
      {
        ...
        bindings = {
          "delete" = ["project_panel::Delete" {skip_prompt = false;}];
          "backspace" = ["project_panel::Delete" {skip_prompt = false;}];
        };
      }
    ];
  };
